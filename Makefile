...
SRC_DIR = src
SRC_FILES = main.c parse.c parse_redirs.c exec.c redirections.c heredoc.c signals.c terminal.c errors.c expand.c env.c initializers.c debug.c
...
leaks: $(NAME) $(VAL_SUPP)
	valgrind --track-origins=yes --show-leak-kinds=all --track-fds=yes --suppressions=readline.supp --leak-check=full ./$(NAME) #--log-file=valgrind.out 
